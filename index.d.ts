...
export declare const connect: (address: string, username: string, password: string, vpnType?: VpnType, mtu?: number, sharedSecret?: string, groupName?: string) => Promise<void>;
